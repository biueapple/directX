...
LPDIRECT3DTEXTURE9      g_pTexture[4] = {}; // Our texture
bool teb = false;
...
HRESULT InitGeometry()
{
    ...
    if( FAILED( D3DXCreateTextureFromFile( g_pd3dDevice, L"image1.jfif", &g_pTexture[0] ) ) )
    {
        // If texture is not in current folder, try parent folder
        if( FAILED( D3DXCreateTextureFromFile( g_pd3dDevice, L"..\\banana.bmp", &g_pTexture[0] ) ) )
        {
    ...
    // Use D3DX to create a texture from a file based image
    if (FAILED(D3DXCreateTextureFromFile(g_pd3dDevice, L"image2.jfif", &g_pTexture[1])))
    {
        // If texture is not in current folder, try parent folder
    ...
    D3DXCreateTextureFromFile(g_pd3dDevice, L"image3.jfif", &g_pTexture[2]);
    D3DXCreateTextureFromFile(g_pd3dDevice, L"image4.jfif", &g_pTexture[3]);
    ...
    CUSTOMVERTEX vertices1[3] = { {{1.0f,1.0f,0.0f},0xffffffff,0.5f,0 },
                                {{0.0f,-1.0f,0.0f},0xffffffff,0,1 } ,
                                {{2.0f,-1.0f,0.0f},0xffffffff,1,1 },
};
    ...
    if (FAILED(g_pVB2->Lock(0, 0, (void**)&pVertices, 0)))
        return E_FAIL;


    CUSTOMVERTEX vertices2[3] = {{{-1.0f,1.0f,0.0f},0xffffffff,0.5f,0 },
                                {{-2.0f,-1.0f,0.0f},0xffffffff,0,1 },
                                {{0.0f,-1.0f,0.0f},0xffffffff,1,1 }
    };
